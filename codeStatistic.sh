...
# 项目所有目录
ITEM_PATH=/Users/hougr/houWork/myCode/android/bus/houCode
# 统计结果输出文件
curRecordFile=/Users/hougr/houWork/myCode/android/bus/houCode/EventBusPro/gitCodeStat-`date "+%Y%m"`".log"
